...
public class ReadXML {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		  try {
		         File inputFile = new File("/Users/saikrisv/Documents/workspace/TestNGParallel/merged_xml.xml");
		         ...
		         for (int temp = 0; temp < tests.size(); temp++) {    
		            ...
		            for (int count = 0; 
		               count < testcases.size(); count++) {	 
		               Element carElement = testcases.get(count);
		               Attribute typeAttribute = carElement.getAttribute("name");
		               if(typeAttribute !=null)
		                  System.out.println("TestMethod in *********"+attribute.getValue()+ typeAttribute.getValue());
		               else{
		                  System.out.println("");
		               }
