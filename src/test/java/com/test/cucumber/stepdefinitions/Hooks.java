...
public class Hooks extends ExtentCucumberFormatter {
    @Before public void beforeClass(Scenario scenario) throws Exception {
        ...
        iosCapabilities = appiumParallelTest.deviceCapabilityManager.iosNative(appiumParallelTest.device_udid);
        androidCapabilities = appiumParallelTest.deviceCapabilityManager.androidNative(appiumParallelTest.device_udid);
    }
