...
public class CustomeListener implements IInvokedMethodListener {
    ...
    public void afterInvocation(IInvokedMethod method, ITestResult testResult) {
        ...
        System.out.println("After DeviceId" + AppiumDeviceManager.getAppiumDevice().getDevice().getUdid());
    ...
    public void beforeInvocation(IInvokedMethod method, ITestResult testResult) {
        ...
        System.out.println("Before DeviceId" + AppiumDeviceManager.getAppiumDevice().getDevice().getUdid());
        System.err.println(msg);
    }
}