...
public class CucumberListener implements StepReporter, ISuiteListener {
  ...
  public void onStart(ISuite iSuite) {
    try {
      System.out.println("ab: onStart: " + iSuite.toString());
  ...
  public void onFinish(ISuite iSuite) {
    try {
      System.out.println("ab: onFinish: " + iSuite.toString());
  ...
  @Override
  public void sendStep(@NotNull ItemStatus itemStatus, String s, Throwable throwable, File... files) {
